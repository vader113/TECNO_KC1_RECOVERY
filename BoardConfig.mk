...
TW_DEVICE_VERSION := TWRP_BY_SJ_TECNO_KC1

TW_INCLUDE_CRYPTO := true
TW_INCLUDE_CRYPTO_SAMSUNG := false  # Usually false for MTK
TW_INCLUDE_FBE := false             # Disable this (Your fstab uses forceencrypt, not fileencryption)
